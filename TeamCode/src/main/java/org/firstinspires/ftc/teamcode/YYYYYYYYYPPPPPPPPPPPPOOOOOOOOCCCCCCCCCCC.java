...
@Autonomous(name = "DIFFERENT_CCCCCCCCOOOOOOOOOOOPPPPPPPPPPYYYYYYYYYYY", group = "Vuforia: Team Blue")
public class YYYYYYYYYPPPPPPPPPPPPOOOOOOOOCCCCCCCCCCC extends LinearOpMode {
